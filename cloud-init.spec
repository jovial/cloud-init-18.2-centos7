...
Patch0014: 0014-Log-to-stdout-stderr.patch
...
# (rpmlint) Maybe better to remove shebang?
chmod a+x $RPM_BUILD_ROOT/usr/lib/python2.7/site-packages/cloudinit/cmd/main.py
...
%changelog
* Mon Jun 18 2018 Will Szumski <will@stackhpc.com> 18.2-3
